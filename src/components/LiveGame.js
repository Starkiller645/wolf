...
class LiveGame extends React.Component {
  ...
  EnemyChampsList = () => {
    if (this.state.ingame) {
      ...
      return <div className="enemy-champs">{enemy_images}</div>;
    } else {
      return null;
    }
  };
  ...
  AllyChampsList = () => {
    if (this.state.ingame) {
      ...
      return <div className="ally-champs">{ally_images}</div>;
    } else {
      return null;
    }
  };
